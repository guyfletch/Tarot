...
{
    public class ThreeSpreadViewModel : SpreadViewModel
    {
        public override string SpreadName => "Three";
        private List<Card> cards;
        private int active;
        private readonly Deck deck;
        private readonly TransformedBitmap back;
        private List<TransformedBitmap> CardImages => new() { Card1, Card2, Card3 };
        ...
        public ThreeSpreadViewModel(Deck deck)
        {
            cards = new List<Card>();
            active = 0;
            this.deck = deck;
